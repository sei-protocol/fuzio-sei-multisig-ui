...
import { TxMsgClearAdmin, TxMsgMigrateContract, TxMsgUpdateAdmin } from "../../../types/txMsg";
import { useEffect, useState } from "react";
import { JsonView, darkStyles, defaultStyles } from "react-json-view-lite";
import "react-json-view-lite/dist/index.css";

interface TxMsgClearAdminDetailsProps {
  readonly msg: TxMsgClearAdmin;
}

const TxMsgClearAdminDetails = ({ msg }: TxMsgClearAdminDetailsProps) => {
...
export default TxMsgClearAdminDetails;
